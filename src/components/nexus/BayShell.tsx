    ...
    <div className="relative">
      ...
      <section className="relative min-h-screen w-full overflow-hidden bg-[#05070a]">
        ...
        <img
          ...
          className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ease-out ${heroLoaded ? "opacity-100" : "opacity-0"}`}
          style={{ filter: `brightness(${ambientBrightness.toFixed(3)}) contrast(1.06) saturate(0.72) hue-rotate(-8deg)` }}
          draggable={false}
          loading="eager"
          decoding="async"
