  ...
  return (
    ...
    >
      ...
      {/* Lock-on ENTER prompt — desktop/tablet only; on mobile the stacked
          selector below the console is the primary way in. */}
      {lockedZone && (
        <div className="absolute inset-x-0 bottom-20 z-20 hidden md:flex justify-center pointer-events-none px-4">
          <button
            onPointerDown={(e) => e.stopPropagation()}
      ...
      <div
        className="absolute right-3 top-28 z-20 anim-fade-up hidden md:block"
