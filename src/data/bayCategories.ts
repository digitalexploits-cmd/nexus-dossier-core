...
const capabilityBrief: BayContent = {
  ...
  categories: [
    ...
    },
    {
      ...
      icon: "grant",
      blurb: "SBIR proposal materials and commercialization funding drafts.",
      assets: [
        {
          id: "prop-nsf-canonical",
          title: "NSF SBIR Phase I — Full Draft (Canonical)",
          kind: "pdf",
          localHref: "/proposals/nsf-sbir-phase1-canonical.pdf",
        ...
        },
        {
          ...
          kind: "pdf",
          localHref: "/proposals/sbir-proposal-2026-07-01.pdf",
          meta: "Working draft",
        },
      ],
    },
...
const operationsCenter: BayContent = {
  ...
  categories: [
    ...
    },
    {
      ...
      icon: "check",
      blurb: "Dataset validation artifacts and the evidence manifest.",
      assets: [
        {
          id: "val-paderborn",
          title: "Official Paderborn Validation Results",
          kind: "pdf",
          localHref: "/evidence/paderborn-validation-results.pdf",
        ...
        },
        {
          ...
          kind: "pdf",
          localHref: "/evidence/ieee-phm-femto-bearing-results.pdf",
          meta: "Dataset validation",
        },
        {
          id: "val-evidence-register",
          title: "NSF Evidence Manifest",
          kind: "text",
          localHref: "/evidence/nsf-evidence-manifest.txt",
          meta: "Evidence register",
        },
      ],
    },
    {
